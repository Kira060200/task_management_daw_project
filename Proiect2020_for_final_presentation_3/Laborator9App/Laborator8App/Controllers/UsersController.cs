...
namespace Laborator8App.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Show(string id)
        {
            ...
            /*var userRNs = from role in db.UserRoles
                          where role.UserId == User.Identity.GetUserId()
                          select role.RoleId;
                          */
        ...
        public ActionResult Delete(string id)
        {
            ...
            var teams = db.Teams.Where(a => a.UserId == id);
            ...
            var members = db.Members.Where(t => t.UserId == id);
